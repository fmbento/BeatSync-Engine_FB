...
def _process_video_impl(audio_file: str, video_files: VideoFilesInput,
                       ...
                       custom_fps: float, variety: float, min_beats: int,
                       session_state: dict,
    ...
    with app:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        variety_slider = gr.Slider(label=LABEL_VARIETY, minimum=0.0, maximum=1.0, value=0.5, step=0.05, info=INFO_VARIETY)
                        min_beats_slider = gr.Slider(label=LABEL_MIN_BEATS, minimum=1, maximum=8, value=1, step=1, info=INFO_MIN_BEATS)
        ...
        process_btn.click(
            ...
            inputs=[
                ...
                variety_slider, min_beats_slider,
                session_state
            ],
