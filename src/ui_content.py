...
# Variety and Min Beats
LABEL_VARIETY = "🎲 Variedade de Clips"
INFO_VARIETY = "Aumenta a diversidade de Clips (evita repetições)"
LABEL_MIN_BEATS = "⏱️ Duração Mínima (Batidas)"
INFO_MIN_BEATS = "Número mínimo de batidas por clip"
